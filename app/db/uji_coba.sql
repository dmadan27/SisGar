...
-- CALL tambah_sewa(id_member, id_parkir, id_nopol, jenis, harga, tgl, jatuh, status, admin);
	...
	CALL tambah_sewa(6, 6, 7, 'T', 2500000, '2017-05-30', '2018-05-30', '0', 'lordRaze'); -- dirman
	CALL tambah_sewa(2, 7, 2, 'B', 250000, '2017-05-31', '2017-07-01', '0', 'lordRaze'); -- kris
	...
	CALL tambah_sewa(2, 7, 2, 'B', 250000, '2017-07-27', '2017-08-27', '0', 'lordRaze'); -- kris
	...
	CALL tambah_sewa(2, 7, 2, 'B', 250000, '2017-08-27', '2017-09-27', '0', 'lordRaze'); -- kris
	...
	CALL tambah_sewa(2, 7, 2, 'B', 250000, '2017-09-27', '2017-10-27', '0', 'lordRaze'); -- kris

	-- bulan oktober
	CALL tambah_sewa(9, 8, 10, 'B', 250000, '2017-10-01', '2017-11-06', '1', 'lordRaze'); -- yayat
	...
	CALL tambah_sewa(2, 7, 2, 'B', 250000, '2017-10-27', '2017-11-27', '1', 'lordRaze'); -- kris
...
('', 'k', 'TAKSI KE KOTABUMI', 350000,'lordRaze'),
